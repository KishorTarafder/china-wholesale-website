...
module.exports = {
  ...
  theme: {
    extend: {
      // China Wholesale Brand Colors
      colors: {
        brand: {
          primary: '#E3431F',     // Logo Orange-Red - for CTAs, icons, headlines
          secondary: '#000000',   // Deep Black - for text, footer, strong contrast
          accent: '#F2F2F2',      // Neutral Gray - for dividers, form fields
          background: '#FFFFFF',  // Clean White - for general background
        },
